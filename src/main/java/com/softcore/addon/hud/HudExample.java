package com.softcore.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(SoftcoreAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
